...
import pataArthur from "../assets/images/pataArthur.png";
import pataArthur2 from "../assets/images/pataArthur2.png";
import pataArthur3 from "../assets/images/pataArthur3.png";
export function AboutArthur() {
  return (
    <>
      <h1 className="font-bold text-[40px] md:text-[86px] text-brown text-center ">
        ¿Quién es Arthur?
      </h1>
      <div className=" grid-cols-3 gap-4 mb-8 hidden md:grid">
        <div className="relative">
          <img src={arthur1} alt="" />
          <img src={pataArthur} alt="" className="absolute bottom-28" />
        </div>
        <div className="relative">
          <img src={arthur2} alt="" />
          <img
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-6">
        <div className="flex flex-col gap-4">
          <div className="bg-red p-2 rounded-xl md:min-h-48">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative md:hidden flex justify-center">
            ...
            <img
              src={pataArthur3}
              alt=""
              className="absolute bottom-0 right-[30%] w-11"
            />
          </div>
        </div>
