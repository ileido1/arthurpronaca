    ...
    <div className="">
      <div className="container grid grid-cols-1 md:grid-cols-2  justify-center">
        <div className=" text-center flex items-center flex-col justify-center md:text-start md:items-start md:justify-normal gap-1 ">
          ...
          <h3 className=" text-2xl font-bold text-lightbrown leading-[32px] md:text-[50px] md:leading-[66.4px]">
            DESCUBRE LA HUELLA DE
          </h3>
          <h1 className="font-bold text-[85px] text-lightbrown  leading-[112px] md:text-[160px] md:leading-[212.48px]">
            ARTHUR
          </h1>
          <h5 className="font-bold text-base text-lightbrown leading-[22px]  md:text-[32px] md:leading-[42.5px]  uppercase">
